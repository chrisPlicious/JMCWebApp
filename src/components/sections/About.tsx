    ...
    <section id="about" className="bg-white ">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 items-center ">
        <div className="col-span-2 py-20 lg:py-28 ">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mx-15">
            {/* Text Content */}
            <div>
              ...
              >
                Renewable Energy{' '}
                <span className="text-solar-500">Advocates</span>{' '}
                for the Philippines
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed mb-4">
                JMC Solar PH — also known as JMC Power — is a renewable energy company headquartered in Ormoc City, Leyte. We are passionate advocates for the shift toward clean, sustainable energy throughout the Visayas region.
              </p>
              <p className="text-slate-600 leading-relaxed mb-8">
                Our mission is simple: <strong className="text-navy-900">provide free and clean energy for every industry</strong> — from small residential homes to large commercial establishments and industrial operations.
              </p>
              {/* Highlight Checklist */}
              <ul className="space-y-3 mb-10">
                {highlights.map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <CheckCircle2 size={20} className="text-green-eco flex-shrink-0" />
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative bg-gradient-to-br from-navy-900 to-navy-800 rounded-3xl p-8 overflow-hidden">
                ...
                <blockquote className="relative z-10">
                  <p className="text-slate-200 text-lg leading-relaxed italic mb-6">
                    "JMC Solar is an advocate of renewable energy to provide free and clean energy for every industry."
                  </p>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-white font-semibold text-sm block">JMC Solar PH</span>
                      <span className="text-slate-400 text-xs">Ormoc City, Leyte, Philippines</span>
                    </div>
                  </div>
                </blockquote>
              </div>
              ...
              <div className="bg-solar-500/10 border border-solar-500/20 rounded-2xl p-4 flex items-start gap-3">
                <Leaf size={20} className="text-green-eco flex-shrink-0 mt-0.5" />
                <div>
                  <span className="text-navy-900 font-semibold text-sm block mb-1">Service Areas</span>
                  <span className="text-slate-600 text-sm">
                    Ormoc City · Cebu Port Center · ZBO · Ipil · Eastern Visayas & surrounding regions
                  </span>
                </div>
              </div>
            </div>
